        ...
        <div className="max-w-lg w-full">
          ...
          <div className="hidden md:flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/register" className="border border-gray-800 px-5 py-2 rounded text-sm font-semibold hover:bg-gray-100 transition">
                Register
              </a>
            </div>
          </div>
          ...
          <div className="md:hidden flex flex-col items-center gap-4 mt-8">
            <div className="flex items-center gap-2">
              ...
              <a href="/register" className="text-sm font-bold text-[#021422] underline">Register</a>
            </div>
          </div>
        </div>
      </div>
