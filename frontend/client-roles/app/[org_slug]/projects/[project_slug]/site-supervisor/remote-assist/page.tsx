...
export default function SiteSupervisorRemoteAssistPage({ params }: RemoteAssistPageProps) {
  ...
  const handleGenerateReport = () => {
    ...
    setTimeout(() => {
      ...
      if (session) {
        router.push(
          `/${org_slug}/projects/${project_slug}/site-supervisor/dashboard`,
        );
      }
    }, 500);
  };
  ...
  if (loading) {
    return (
      <div>
        <CrewHeader title="Remote Assist" badge="Digital Eye" />
