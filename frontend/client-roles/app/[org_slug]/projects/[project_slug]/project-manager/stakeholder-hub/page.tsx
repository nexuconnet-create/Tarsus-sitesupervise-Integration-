    ...
    return (
        <div className="pb-24">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white py-7 px-4">
                <div className="flex items-center gap-3"><BackButton /><div className="text-2xl font-bold text-[#021422]">Stakeholder HUB — {activeProject.name}</div></div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {crewPerformance && crewPerformance.length > 0 ? crewPerformance.map((crew: any, idx: number) => (
                                    <div key={idx} className="border p-4 rounded text-base text-gray-700 space-y-2 font-medium">
                                        ...
                                        <div className="flex justify-between text-sm"><span>Safety Score</span> <span>{crew.performance_metrics?.safety ?? '—'}%</span></div>
                                        <div className="flex justify-between text-sm"><span>Efficiency</span> <span>{crew.performance_metrics?.efficiency ?? '—'}%</span></div>
                                        <div className="flex justify-between text-sm"><span>Quality</span> <span>{crew.performance_metrics?.quality ?? '—'}%</span></div>
                                        <div className="flex justify-between text-sm"><span>Collaboration</span> <span>{crew.performance_metrics?.collaboration ?? '—'}%</span></div>
                                    </div>
                                )) : (
