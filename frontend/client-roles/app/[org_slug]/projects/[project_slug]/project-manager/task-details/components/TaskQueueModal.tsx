          ...
          {filteredTasks.length === 0 ? (
            ...
            <table className="w-full">
              <thead className="bg-gray-50 sticky top-0">
                <tr>
                  <th className="w-[8%] px-3 py-3 text-left text-[10px] font-bold uppercase text-gray-500 tracking-wider">
                    Task ID
                  </th>
                  <th className="w-[35%] px-3 py-3 text-left text-[10px] font-bold uppercase text-gray-500 tracking-wider">
                    Title
                  </th>
                  <th className="w-[22%] px-3 py-3 text-left text-[10px] font-bold uppercase text-gray-500 tracking-wider">
                    Location
                  </th>
                  <th className="w-[25%] px-3 py-3 text-left text-[10px] font-bold uppercase text-gray-500 tracking-wider">
                    Crews
                  </th>
                  <th className="w-[10%] px-1 py-3 text-center text-[10px] font-bold uppercase text-gray-500 tracking-wider">
                    TO-DO
                  </th>
                  <th className="w-[10%] px-1 py-3 text-center text-[10px] font-bold uppercase text-gray-500 tracking-wider">
                    In Progress
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredTasks.map((task) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3">
                      <span className="text-xs text-[#021422] line-clamp-2 leading-tight">
                        {task.title}
                      </span>
                    </td>
                    <td className="px-3 py-3">
                    ...
                    <td className="px-1 py-3 text-center">
                      <button
                        onClick={() => handleQueueToggle(task.id, "todo")}
                      ...
                      >
                        {task.queue === "todo" && <Check size={8} />}
                      </button>
                    </td>
                    <td className="px-1 py-3 text-center">
                      <button
                        onClick={() =>
                          handleQueueToggle(task.id, "in_progress")
                        }
                        className={`w-3.5 h-3.5 rounded border flex items-center justify-center transition-all mx-auto ${
                      ...
                      >
                        {task.queue === "in_progress" && <Check size={8} />}
                      </button>
                    </td>
                    <td className="px-1 py-3 text-center">
                      <button
                        onClick={() => handleQueueToggle(task.id, "on_hold")}
                        className={`w-3.5 h-3.5 rounded border flex items-center justify-center transition-all mx-auto ${
                          task.queue === "on_hold"
                            ? "bg-[#007AFF] border-[#007AFF] text-white"
                            : "border-gray-300 hover:border-[#007AFF]"
                      ...
                      >
                        {task.queue === "on_hold" && <Check size={8} />}
                      </button>
                    </td>
                    <td className="px-1 py-3 text-center">
                      <button
                        onClick={() => handleQueueToggle(task.id, "completed")}
                        className={`w-3.5 h-3.5 rounded border flex items-center justify-center transition-all mx-auto ${
                      ...
                      >
                        {task.queue === "completed" && <Check size={8} />}
                      </button>
                    </td>
                    <td className="px-1 py-3 text-center">
                      <button
                        onClick={() =>
                          handleQueueToggle(task.id, "uncompleted")
                        }
                        className={`w-3.5 h-3.5 rounded border flex items-center justify-center transition-all mx-auto ${
                          task.queue === "uncompleted"
                            ? "bg-[#007AFF] border-[#007AFF] text-white"
                            : "border-gray-300 hover:border-[#007AFF]"
                        }`}
                      >
                        {task.queue === "uncompleted" && <X size={8} />}
                      </button>
                    </td>
                    <td className="px-1 py-3 text-center">
                      <button
                        onClick={() => handleQueueToggle(task.id, "cancelled")}
                        className={`w-3.5 h-3.5 rounded border flex items-center justify-center transition-all mx-auto ${
