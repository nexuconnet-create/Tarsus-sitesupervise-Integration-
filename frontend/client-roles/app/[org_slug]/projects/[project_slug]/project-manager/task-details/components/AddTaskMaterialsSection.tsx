...
import { Plus, Trash2, Package, AlertCircle, PlusCircle, ClipboardList } from "lucide-react";
                    ...
                    {parseFloat(quantity) > selectedMaterial.currentStock && (
                      <div className="border border-amber-200 bg-amber-50 rounded-lg p-3 space-y-2">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <p className="text-xs font-semibold text-amber-800">Insufficient Stock</p>
                            <p className="text-xs text-amber-700 mt-0.5">
                              Need: {quantity} {selectedMaterial.unit} · Available: {selectedMaterial.currentStock} {selectedMaterial.unit} · Short: {parseFloat(quantity) - selectedMaterial.currentStock} {selectedMaterial.unit}
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-2">
                            ...
                            <button
                              ...
                              onClick={() => {
                                onCreateRequest({
                                  ...
                                  unit: selectedMaterial.unit,
                                  quantityRequested: parseFloat(quantity) - selectedMaterial.currentStock,
                                });
                              }}
                              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 bg-[#021422] text-white rounded-lg text-xs font-medium hover:bg-gray-900 transition-colors"
                            >
                          ...
                          <button
                            ...
                            className="flex-1 px-3 py-1.5 border border-gray-300 text-gray-600 rounded-lg text-xs font-medium hover:bg-gray-100 transition-colors"
                          >
                            Continue
                          </button>
                        </div>
