...
interface ReadOnlyTaskTrackerProps {
  ...
  /** Called whenever the checklist completion % changes — drives task.progress */
  ...
  taskId?: string;
  /** Project UUID — needed to persist checklist ticks to the DB */
  projectUuid?: string;
  ...
  const handleToggleItem = (itemId: string) => {
    ...
    if (projectUuid && taskId) {
      taskService
        ...
        .then(() => {
          // Only sync progress after the toggle succeeds
          if (onProgressChange) {
