...
export default function ClientDashboardLayout({ children, params }: ClientDashboardLayoutProps) {
  ...
  useRoleGuard(org_slug, project_slug, "client");
  ...
  }, [clientType, org_slug, project_slug, router]);
  ...
  const base = `/${org_slug}/projects/${project_slug}/${rolePath}`;
