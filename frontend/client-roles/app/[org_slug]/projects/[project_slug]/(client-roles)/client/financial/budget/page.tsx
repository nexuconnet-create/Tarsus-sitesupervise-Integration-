    ...
    <div className="h-screen bg-[#E3E3E3] text-slate-900 font-sans flex flex-col overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-100 px-8 py-5 flex flex-col lg:flex-row lg:items-center justify-between gap-4 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button onClick={() => setIsShareModalOpen(true)} className="px-4 py-2 bg-white border border-gray-100 hover:bg-white text-slate-700 rounded-lg text-sm font-bold transition-colors shadow-sm flex items-center gap-2">
        ...
        <div className="p-8 max-w-7xl mx-auto space-y-8">
          ...
          <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="flex flex-wrap items-center justify-between border-t border-slate-100 pt-6 mt-4 gap-4">
              ...
              <div className="flex items-center gap-6 bg-white px-4 py-2 rounded-lg border border-slate-100">
          ...
          <section className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <table className="w-full text-left text-sm whitespace-nowrap">
                ...
                <tbody className="divide-y divide-slate-100">
                  {invoices.map((inv, idx) => (
                    <tr key={idx} className="hover:bg-white transition-colors group cursor-pointer">
            ...
            <div className="p-4 border-t border-slate-100 bg-white flex flex-wrap items-center gap-3 shrink-0">
              <button onClick={() => setIsAllInvoicesOpen(true)} className="px-4 py-2 bg-white border border-gray-100 hover:bg-slate-100 text-slate-700 rounded-lg text-sm font-bold transition-colors shadow-sm flex items-center gap-2">
                <BarChart4 size={16} /> View All Invoices
              </button>
              <button onClick={handleDownload} disabled={isDownloading} className="px-4 py-2 bg-white border border-gray-100 hover:bg-slate-100 text-slate-700 rounded-lg text-sm font-bold transition-colors shadow-sm flex items-center gap-2 disabled:opacity-70">
                <Download size={16} /> {isDownloading ? 'Downloading...' : 'Download Statement'}
              </button>
              <button onClick={() => setIsSupportModalOpen(true)} className="px-4 py-2 bg-white border border-gray-100 hover:bg-slate-100 text-slate-700 rounded-lg text-sm font-bold transition-colors shadow-sm flex items-center gap-2">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <div className="flex gap-2">
                  <input type="email" placeholder="client@example.com" className="flex-1 border border-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" />
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input type="text" readOnly value="https://sitesupervise.com/reports/fin-123" className="flex-1 border border-gray-100 rounded-lg px-3 py-2 text-sm bg-white text-slate-500" />
                  <button className="px-4 py-2 border border-gray-100 text-slate-700 rounded-lg text-sm font-bold hover:bg-white flex items-center gap-2">
                    <Link size={16} /> Copy
                  </button>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-xl overflow-hidden" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input type="text" placeholder="e.g. Question about Invoice INV-2026-023" className="w-full border border-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500" />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase mb-2">Message</label>
                <textarea rows={4} placeholder="Describe your issue..." className="w-full border border-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500"></textarea>
              </div>
              <div className="flex justify-end gap-2 pt-2">
                <button onClick={() => setIsSupportModalOpen(false)} className="px-4 py-2 border border-gray-100 text-slate-700 rounded-lg text-sm font-bold hover:bg-white">Cancel</button>
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="p-4 border-b border-slate-100 bg-white flex items-center justify-between gap-4">
            <div className="relative flex-1">
              ...
              <input type="text" placeholder="Search by vendor or ID..." className="w-full pl-9 pr-4 py-2 border border-gray-100 rounded-lg text-sm focus:outline-none focus:border-blue-500" />
            </div>
            <button className="px-4 py-2 border border-gray-100 text-slate-700 rounded-lg text-sm font-bold hover:bg-slate-100 bg-white">Filter</button>
          </div>
