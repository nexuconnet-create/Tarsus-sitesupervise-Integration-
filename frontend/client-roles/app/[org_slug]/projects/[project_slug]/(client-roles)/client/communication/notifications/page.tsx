    ...
    <div className="h-screen bg-[#E3E3E3] text-slate-900 font-sans flex flex-col overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-100 px-8 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button className="p-2.5 bg-white border border-gray-100 text-slate-700 hover:bg-white rounded-lg transition-colors shadow-sm">
            <Settings size={18} />
          </button>
        </div>
      </div>
                    ...
                    <div 
                      ...
                      className={`p-4 rounded-2xl border transition-all cursor-pointer ${
                        notification.unread 
                          ...
                          : 'bg-white/60 border-gray-100 shadow-sm hover:bg-white hover:shadow-md'
                      } flex gap-4`}
                    >
