        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-white/50 border-b border-gray-100 text-xs font-bold text-slate-500 uppercase tracking-wider">
                  ...
                  <tr key={member.id} className="hover:bg-white/80 transition-colors group">
                    ...
                    <td className="p-4 pr-6">
                      <div className="flex items-center justify-end gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                        <Link href={`/${org_slug}/projects/${project_slug}/client/communication/messages`} className="w-8 h-8 flex items-center justify-center rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors" title="Message">
                          <MessageSquare size={14} />
                        </Link>
                        <Link href={`/${org_slug}/projects/${project_slug}/client/communication/messages`} className="w-8 h-8 flex items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100 transition-colors" title="Call">
                          <Phone size={14} />
                        </Link>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm divide-y divide-slate-100">
                {vendorContacts.map((vendor, idx) => (
                  <tr key={vendor.id} className="hover:bg-white/80 transition-colors group">
                    <td className="p-4 pl-6 font-medium text-slate-400">{idx + 1}</td>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input type="text" placeholder="e.g. Engr. Olabisi" className="w-full border border-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1">Email Address</label>
                <input type="email" placeholder="email@example.com" className="w-full border border-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
              <div>
            ...
            <div className="p-4 border-t border-slate-100 bg-white flex justify-end gap-2">
              <button onClick={() => setIsAddMemberModalOpen(false)} className="px-4 py-2 bg-white border border-gray-100 text-slate-700 font-medium rounded-lg hover:bg-white transition-colors text-sm">Cancel</button>
