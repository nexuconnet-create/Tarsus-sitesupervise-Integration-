        ...
        <div className="flex flex-col xl:flex-row gap-6 flex-1 min-h-0">
          ...
          <div className="w-full xl:w-[400px] shrink-0 flex flex-col gap-6 min-h-0">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col flex-1 min-h-0 overflow-hidden">
              <div className="p-5 border-b border-slate-100 flex items-center justify-between shrink-0 bg-white/50">
              ...
              <div className="p-4 flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="space-y-1">
                  ...
                  <div>
                    <div 
                      className="flex items-center gap-2 p-2 hover:bg-white rounded-lg cursor-pointer text-slate-700 font-semibold text-sm group"
                    ...
                    {expandedFolders.includes('project_docs') && (
                      <div className="ml-6 border-l border-gray-100 pl-2 mt-1 space-y-1">
                        ...
                        <div>
                          <div 
                            className="flex items-center justify-between p-2 hover:bg-white rounded-lg cursor-pointer text-slate-600 text-sm group"
                          ...
                          {expandedFolders.includes('drawings') && (
                            <div className="ml-6 border-l border-gray-100 pl-2 mt-1 space-y-1">
                              <div className="flex items-center justify-between p-2 hover:bg-white rounded-lg cursor-pointer text-slate-600 text-sm group">
                        ...
                        {[
                          ...
                          <div key={idx} className="flex items-center justify-between p-2 hover:bg-white rounded-lg cursor-pointer text-slate-600 text-sm group">
                            <div className="flex items-center gap-2 font-medium">
              ...
              <div className="p-4 border-t border-slate-100 bg-white/80 grid grid-cols-2 gap-2 shrink-0">
                ...
                <button onClick={() => setIsFolderModalOpen(true)} className="flex items-center justify-center gap-2 p-2.5 bg-white border border-gray-100 hover:bg-white text-slate-700 rounded-lg text-xs font-bold transition-colors shadow-sm">
                  <FolderPlus size={14} className="text-slate-500" /> New Folder
                </button>
                <button onClick={handleExportAll} disabled={isExporting} className="flex items-center justify-center gap-2 p-2.5 bg-white border border-gray-100 hover:bg-white text-slate-700 rounded-lg text-xs font-bold transition-colors shadow-sm disabled:opacity-50">
                  <DownloadCloud size={14} className="text-slate-500" /> {isExporting ? 'Exporting...' : 'Export All'}
                </button>
                <button onClick={() => setIsPermissionsModalOpen(true)} className="flex items-center justify-center gap-2 p-2.5 bg-white border border-gray-100 hover:bg-white text-slate-700 rounded-lg text-xs font-bold transition-colors shadow-sm">
              ...
              <div className="overflow-y-auto custom-scrollbar flex-1 p-2">
                <div className="space-y-1">
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between p-3 hover:bg-white rounded-xl group transition-colors border border-transparent hover:border-slate-100">
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input type="text" placeholder="e.g. Phase 2 Drawings" className="w-full border border-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
              <div>
            ...
            <div className="p-4 border-t border-slate-100 bg-white flex justify-end gap-2">
              <button onClick={() => setIsFolderModalOpen(false)} className="px-4 py-2 bg-white border border-gray-100 text-slate-700 font-medium rounded-lg hover:bg-white transition-colors text-sm">Cancel</button>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-6">
              <div className="flex gap-2">
                <input type="text" placeholder="Invite via email address..." className="flex-1 border border-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <select className="text-xs border border-gray-100 rounded bg-white py-1 px-2 focus:outline-none focus:border-blue-500">
