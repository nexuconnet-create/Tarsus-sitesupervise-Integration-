    ...
    <div className="min-h-screen bg-[#E3E3E3] text-slate-900 font-sans flex flex-col overflow-hidden">
      ...
      <div className="max-w-[1000px] mx-auto px-6 mt-8 mb-12 flex-1 w-full flex flex-col overflow-y-auto custom-scrollbar gap-8 pb-12">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-8 space-y-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 md:gap-8 bg-white p-6 rounded-xl border border-slate-100">
        ...
        <div className="flex flex-wrap items-center justify-end gap-4 mt-2">
          <button className="px-5 py-2.5 bg-white border border-gray-100 text-slate-700 hover:bg-white hover:text-rose-600 rounded-xl text-sm font-bold transition-colors">
            Reset to Defaults
          </button>
