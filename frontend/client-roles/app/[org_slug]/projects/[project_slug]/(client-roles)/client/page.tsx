...
export default function ClientDashboardHome() {
  ...
  const basePath = `/${org_slug}/projects/${project_slug}/client`;

  return (
    <div className="min-h-screen bg-[#E3E3E3] text-slate-900 pb-12 font-sans selection:bg-blue-100">

      {/* 1. Header Section */}
      <div className="bg-white border-b border-gray-100 px-6 py-4 sticky top-0 z-20 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
        <div>
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-12 py-2 bg-white border border-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-slate-400"
          />
          <div className="absolute inset-y-0 right-0 pr-2 flex items-center pointer-events-none">
            <span className="text-[10px] font-bold text-slate-400 bg-white border border-gray-100 px-1.5 py-0.5 rounded shadow-sm">Ctrl K</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-8 max-w-[1400px] mx-auto space-y-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            {/* Progress */}
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm relative overflow-hidden group hover:border-blue-300 transition-colors">
            ...
            {/* Budget */}
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm relative overflow-hidden group hover:border-emerald-300 transition-colors">
            ...
            {/* Timeline */}
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm relative overflow-hidden group hover:border-amber-300 transition-colors">
            ...
            {/* Milestones */}
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm relative overflow-hidden group hover:border-indigo-300 transition-colors">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
              ...
              <div className="absolute bottom-6 right-6 w-80 bg-slate-900/80 backdrop-blur-xl border border-slate-700 p-4 rounded-xl z-20 shadow-2xl">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="h-1.5 w-full bg-slate-800 rounded-full overflow-hidden">
                      <div className="h-full bg-white0 w-[25%]"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col overflow-hidden h-[500px] xl:h-auto">
            <div className="bg-[#021422] text-white p-4 flex items-center justify-between">
              <h2 className="text-sm font-bold flex items-center gap-2">
                <Bell size={16} className="text-amber-500" /> Alerts & Updates
              </h2>
            </div>
            ...
            <div className="p-3 bg-white border-t border-slate-100 grid grid-cols-3 gap-2">
              <button className="text-[10px] font-bold uppercase tracking-wider text-slate-600 bg-white border border-gray-100 py-2 rounded hover:bg-slate-100 transition-colors">View All</button>
              <button className="text-[10px] font-bold uppercase tracking-wider text-slate-600 bg-white border border-gray-100 py-2 rounded hover:bg-slate-100 transition-colors">Timeline</button>
              <button className="text-[10px] font-bold uppercase tracking-wider text-slate-600 bg-white border border-gray-100 py-2 rounded hover:bg-slate-100 transition-colors">Share</button>
            </div>
          </section>
        ...
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-2 md:grid-cols-5 gap-3">
            ...
            <Link href={`${basePath}/project/overview${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/project/reports${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/project/media${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/live-site-view${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/documents/all${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/project/schedule${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/financial/budget${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/team/project-team${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/communication/messages${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
            ...
            <Link href={`${basePath}/settings/profile${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-white hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group">
