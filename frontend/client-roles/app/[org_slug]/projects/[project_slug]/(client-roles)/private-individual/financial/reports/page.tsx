      ...
      <div className="max-w-[1200px] mx-auto px-6 mt-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="mt-3 bg-white border border-slate-100 rounded-lg p-2.5 flex justify-between items-center text-xs font-bold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <section className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 flex flex-col">
            ...
            <div className="flex-1 flex flex-col justify-end min-h-[300px] relative pb-8">
              {/* Fake Graph */}
              <div className="absolute inset-x-0 bottom-8 top-0 border-l border-b border-gray-100 flex items-end">
                {/* Y-Axis Labels */}
