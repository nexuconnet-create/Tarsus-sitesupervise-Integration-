              ...
              {PAYMENTS.map((payment) => {
                ...
                return (
                  <div key={payment.id} className={`flex flex-col md:flex-row md:items-center justify-between p-5 rounded-xl border transition-colors ${
                    isPaid ? 'border-emerald-200 bg-emerald-50/50' : 'border-gray-100 hover:border-blue-300 hover:shadow-md'
                  }`}>
                    ...
                    <div className="flex flex-col md:items-end gap-3 md:min-w-[200px]">
                      ...
                      {isPaid ? (
                        <button className="text-xs font-bold text-slate-600 bg-white border border-gray-100 px-4 py-2 rounded-lg hover:bg-white transition-colors flex items-center gap-1.5 justify-center">
