      ...
      <div className="max-w-[1200px] mx-auto px-6 mt-8 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-100 text-slate-700 text-xs font-bold rounded-lg hover:bg-slate-100 transition-colors">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-slate-100">
            {filteredRequests.map((req) => {
              ...
              return (
                <div key={req.id} className="grid grid-cols-12 gap-4 p-5 items-center hover:bg-white transition-colors group">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden border border-gray-100">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <select className="w-full bg-white border border-gray-100 rounded-lg p-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500">
