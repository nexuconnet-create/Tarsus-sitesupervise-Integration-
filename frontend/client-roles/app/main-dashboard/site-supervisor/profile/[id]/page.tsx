    ...
    return (
        <div className="p-6 md:p-8 space-y-8 bg-[#F8F9FA] min-h-screen">
            ...
            <div className="flex justify-between items-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                <h2 className="text-lg font-bold text-[#021422] uppercase tracking-wider">
                    Crew Member Profile - {member.name} {member.surname} <span className="text-gray-500">(ID: {member.id})</span>
                </h2>
                <div className="flex items-center gap-4">
                    <div className="bg-purple-100 p-1 rounded-full flex">
                        <div className="w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center text-white font-bold text-sm">
                            {member.name[0]}
                        </div>
                        <div className="w-8 h-8 rounded-full bg-slate-500 flex items-center justify-center text-white font-bold text-sm -ml-2 border-2 border-white">
                            {member.surname[0]}
                        </div>
                    </div>
                    <div className="flex gap-2">
                        <button className="px-6 py-2 bg-[#021422] text-white text-xs font-bold uppercase rounded hover:bg-gray-800 transition-colors">
                            Edit
                        </button>
                        <button onClick={() => router.back()} className="px-6 py-2 bg-red-600 text-white text-xs font-bold uppercase rounded hover:bg-red-700 transition-colors">
                            Close
                        </button>
                    </div>
                </div>
