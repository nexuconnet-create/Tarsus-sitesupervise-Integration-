...
const AddInventoryModal = ({ isOpen, onClose, onAdd, editItem }: AddInventoryModalProps) => {
  ...
  const handleRequestSubmit = async (e: React.FormEvent) => {
    ...
    const selectedItem = getAllInventory().find((item) => item.id === requestForm.itemId);
          ...
          <div className="flex border-b border-gray-200">
            <button
              ...
              className={`flex-1 px-4 py-3 text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                activeTab === "material"
                  ? "text-white bg-[#021422]"
                  : "text-gray-500 hover:text-[#021422] hover:bg-gray-50"
              }`}
            >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      placeholder="e.g., Ready-Mix Concrete 4500 PSI"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setMaterialForm({ ...materialForm, reorderQty: Number(e.target.value) })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="e.g., Concrete Mixer #001"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setEquipmentForm({ ...equipmentForm, condition: e.target.value as EquipmentCondition })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    >
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <button
                        type="button"
                        onClick={() => setEquipmentForm({ ...equipmentForm, ownershipType: "owned", cost: undefined })}
                      ...
                      <button
                        type="button"
                        onClick={() => setEquipmentForm({ ...equipmentForm, ownershipType: "rented" })}
                        className={`flex-1 px-3 py-2 text-sm font-medium rounded-lg border transition-colors ${
                      ...
                      <button
                        type="button"
                        onClick={() => setEquipmentForm({ ...equipmentForm, ownershipType: "leased" })}
                        className={`flex-1 px-3 py-2 text-sm font-medium rounded-lg border transition-colors ${
                  ...
                  {/* Cost â€” required for all ownership types */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      {equipmentForm.ownershipType === "rented" ? "Rental Cost" : equipmentForm.ownershipType === "leased" ? "Lease Cost" : "Cost"} ({equipmentForm.ownershipType === "owned" ? "â‚¦" : "â‚¦/day"})
                    </label>
                    <input
                      type="number"
                      min="0"
                      ...
                      onChange={(e) => setEquipmentForm({ ...equipmentForm, cost: Number(e.target.value) })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder={equipmentForm.ownershipType === "owned" ? "Cost" : "e.g., 5000.00"}
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="e.g., Safety Helmet, Safety Gloves"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setPPEForm({ ...ppeForm, currentStock: Number(e.target.value) })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setPPEForm({ ...ppeForm, minStockLevel: Number(e.target.value) })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      value={ppeForm.unit || ""}
                      onChange={(e) => setPPEForm({ ...ppeForm, unit: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={ppeForm.size || ""}
                      onChange={(e) => setPPEForm({ ...ppeForm, size: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="e.g., S/M/L, Universal"
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setPPEForm({ ...ppeForm, supplier: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      step="0.01"
                      value={ppeForm.price ?? ""}
                      onChange={(e) => setPPEForm({ ...ppeForm, price: Number(e.target.value) })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      {getAllInventory().map((item) => (
                        <option key={item.id} value={item.id}>
                          {item.name} ({item.type}) - Stock: {item.currentStock} {item.unit}
                        </option>
                      ))}
                    </select>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setRequestForm({ ...requestForm, priority: e.target.value as "high" | "medium" | "low" })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
                      >
