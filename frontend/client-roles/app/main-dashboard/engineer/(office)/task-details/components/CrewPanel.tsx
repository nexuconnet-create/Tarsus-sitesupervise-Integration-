...
import type { Task, WorkerType } from "../types";
          ...
          <div key={crew.id} className="bg-gray-50 rounded-xl p-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <p className="text-xs font-bold uppercase text-gray-500 tracking-wider">Worker Type</p>
                <p className="text-sm font-medium text-[#021422]">
                  {workerType ? WORKER_TYPE_LABELS[workerType] : "Not set"}
                </p>
              </div>
            </div>
