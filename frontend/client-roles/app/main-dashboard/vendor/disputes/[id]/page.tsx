    ...
    <div className="pb-24">
      <div className="bg-white py-7 px-4 border-b border-gray-100">
        <div className="max-w-7xl mx-auto">
          <button
            onClick={() => router.push("/main-dashboard/vendor/disputes")}
          ...
          <p className="text-sm text-gray-500 mt-1">{dispute.poNumber} &middot; {dispute.projectName}</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Dispute Details</h2>
            ...
            {/* Evidence */}
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Evidence</h2>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">Timeline</h2>
              <p className="text-sm text-gray-600">Dispute management workflow</p>
            </div>

            {/* Timeline — commented out pending client decision on dispute flow
            <div className="bg-white rounded-xl border border-gray-200 p-6">
                  ...
                  <div key={idx} className="flex gap-4">
                    <div className="flex flex-col items-center">
                      <div className={`w-3 h-3 rounded-full border-2 ${
                        idx === 0 ? "bg-amber-500 border-amber-500" : "bg-white border-gray-300"
                      }`} />
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => toast.success("Response submitted")}
                ...
                >
                  <Send size={16} /> Respond to Dispute
                </button>
                <button
                ...
                <button
                  onClick={() => router.push(`/main-dashboard/vendor/messages`)}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-gray-200 text-gray-700 rounded-lg text-sm font-bold hover:bg-gray-50 transition-colors"
                >
                  <MessageCircle size={16} /> Message PM
                </button>
                <button
