...
export default function PrivateIndividualHome() {
  ...
  const basePath = `/main-dashboard/private-individual`;

  return (
    <div className="min-h-screen bg-[#E3E3E3] text-slate-900 pb-12 font-sans selection:bg-blue-100">
      
      {/* 1. Header Section */}
      <div className="bg-white border-b border-slate-200 px-6 py-5 sticky top-0 z-20 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
        <div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 mt-8 space-y-8">
        ...
        {/* 2. Welcome Message */}
        <section className="bg-gradient-to-r from-[#021422] to-[#0A4B7D] rounded-2xl shadow-lg p-8 text-white relative overflow-hidden">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              ...
              <div className="flex gap-4 text-xs font-bold text-slate-600 bg-slate-50 px-4 py-2.5 rounded-lg border border-slate-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-3 flex-1 mb-4">
              <div className="bg-slate-100 rounded-xl aspect-[4/3] relative overflow-hidden group cursor-pointer border border-slate-200">
            ...
            <div className="flex gap-2">
              <button className="flex-1 py-2.5 bg-slate-50 border border-slate-200 text-xs font-bold text-slate-600 rounded-lg hover:bg-slate-100 transition-colors flex items-center justify-center gap-2">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-2 md:grid-cols-5 gap-3">
            ...
            <Link href={`${basePath}/meeting-schedule${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group text-center">
            ...
            <Link href={`${basePath}/documents/all${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group text-center">
            ...
            <Link href={`${basePath}/communication/messages${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group text-center">
            ...
            <Link href={`${basePath}/financial/reports${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group text-center">
            ...
            <Link href={`${basePath}/settings/notifications${querySuffix}`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all group text-center">
