...
export default function MyPropertyProgressPage() {
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 pb-12 font-sans selection:bg-blue-100">
      ...
      {/* Header */}
      <div className="bg-white border-b border-slate-200 px-6 py-5 sticky top-0 z-20 shadow-sm flex items-center justify-between">
        <div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 mt-8 space-y-8">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 w-full space-y-6">
            ...
            <div className="flex flex-wrap gap-4 text-xs font-bold text-slate-600">
              <div className="bg-slate-50 px-4 py-2.5 rounded-lg border border-slate-100 flex-1 min-w-[150px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <section className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 relative">
              ...
              <button className="w-full mt-6 py-3 border border-slate-200 rounded-lg text-xs font-bold text-slate-600 hover:bg-slate-50 transition-colors flex items-center justify-center gap-2">
