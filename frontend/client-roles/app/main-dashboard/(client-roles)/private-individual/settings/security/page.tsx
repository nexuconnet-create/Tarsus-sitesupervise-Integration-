        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            <div>
              ...
              <input type="password" placeholder="••••••••" className="w-full sm:max-w-md bg-white border border-slate-200 rounded-lg p-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all" />
            </div>
            <div>
            ...
            <div className="pt-2">
              <button className="px-6 py-2.5 bg-[#021422] text-white text-sm font-bold rounded-lg hover:bg-[#0A4B7D] transition-colors shadow-sm">
                Update Password
              </button>
            </div>
          </div>
