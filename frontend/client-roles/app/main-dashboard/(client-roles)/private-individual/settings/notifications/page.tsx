    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 pb-12 font-sans selection:bg-blue-100">
      ...
      <div className="max-w-[800px] mx-auto px-6 mt-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="grid grid-cols-12 gap-4 p-4 border-b border-slate-100 bg-slate-50 text-[10px] font-bold text-slate-400 uppercase tracking-wider text-center">
          ...
          <div className="divide-y divide-slate-100">
            ...
            {/* Financial Updates */}
            <div className="grid grid-cols-12 gap-4 p-5 items-center hover:bg-slate-50 transition-colors">
