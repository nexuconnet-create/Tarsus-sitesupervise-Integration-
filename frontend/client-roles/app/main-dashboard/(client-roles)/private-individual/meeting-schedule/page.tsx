      ...
      <div className="max-w-[1000px] mx-auto px-6 mt-8 space-y-8">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl shadow-lg p-6 md:p-8 text-white relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="relative z-10">
            <button className="w-full md:w-auto bg-white text-blue-700 px-6 py-3 rounded-xl font-bold text-sm shadow-md hover:bg-slate-50 transition-colors">
              Manage Appointment
            </button>
          </div>
        </div>
              ...
              return (
                <div key={visit.id} className="flex gap-4 sm:gap-6 relative z-10 group">
                  ...
                  <div className={`flex-1 p-5 rounded-xl border transition-all ${
                    isUpcoming ? 'bg-slate-50 border-slate-200 hover:border-blue-300' : 'bg-white border-slate-100 opacity-70 hover:opacity-100'
                  }`}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="date" className="w-full bg-white border border-slate-200 rounded-lg p-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Time</label>
                  <select className="w-full bg-white border border-slate-200 rounded-lg p-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label className="flex-1 border border-slate-200 rounded-lg p-3 flex items-center gap-2 cursor-pointer hover:bg-slate-50">
