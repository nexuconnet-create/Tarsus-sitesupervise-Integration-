...
export default function ChatWithPMPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#F8FAFC] text-slate-900 font-sans selection:bg-blue-100">
      ...
      <div className="flex-1 flex flex-col max-w-[1000px] w-full mx-auto px-4 md:px-6 py-6 overflow-hidden">
        ...
        <div className="flex-1 bg-white border border-slate-200 rounded-2xl shadow-sm flex flex-col overflow-hidden">
          ...
          <div className="p-4 bg-white border-t border-slate-100">
            <div className="flex items-end gap-2 bg-slate-50 border border-slate-200 p-2 rounded-xl focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all">
