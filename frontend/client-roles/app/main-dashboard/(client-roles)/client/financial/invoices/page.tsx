        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="w-48 pl-9 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50"
            />
          </div>
        ...
        <div className="flex flex-col xl:flex-row gap-8 flex-1 min-h-0">
            ...
            <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col flex-1 min-h-0">
              ...
              <div className="overflow-y-auto custom-scrollbar flex-1">
                <table className="w-full text-left text-sm whitespace-nowrap">
                  <thead className="bg-slate-50 text-slate-500 text-[11px] uppercase font-bold tracking-wider border-b border-slate-200 sticky top-0 z-10">
                    <tr>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {invoicesData.map((inv) => (
                      <tr 
                        ...
                        className={`cursor-pointer transition-colors group ${selectedId === inv.id ? 'bg-blue-50/50' : 'hover:bg-slate-50'}`}
                      >
          ...
          <div className="xl:w-[500px] shrink-0 flex flex-col min-h-0">
            ...
            <div className="flex-1 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden flex flex-col min-h-0">
              ...
              {/* Document Header */}
              <div className="bg-slate-50 border-b border-slate-200 p-6 shrink-0 flex items-start justify-between">
                <div>
                ...
                <div className="text-right">
                  <span className="bg-white border border-slate-200 px-3 py-1 rounded-md text-xs font-bold text-slate-500 uppercase tracking-wider shadow-sm">
                    Invoice
                  </span>
              ...
              <div className="flex-1 overflow-y-auto p-6 bg-[url('https://www.transparenttextures.com/patterns/clean-gray-paper.png')]">
                ...
                <div className="mt-8 flex justify-end">
                  <div className="w-64">
                    <div className="flex justify-between py-2 text-sm font-bold border-b border-slate-200 text-slate-600">
                      <span>Subtotal</span>
              ...
              <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-3 shrink-0">
                ...
                <button className="px-4 py-2.5 bg-white border border-slate-200 hover:bg-slate-100 text-slate-700 rounded-xl text-sm font-bold transition-colors flex items-center justify-center shadow-sm" title="Print Document">
                  <Printer size={16} />
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="e.g. INV-12345" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <input type="text" placeholder="0.00" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono" />
                </div>
              </div>
            </div>
