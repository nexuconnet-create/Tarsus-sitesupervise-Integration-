    ...
    <div className="h-screen bg-[#F8FAFC] text-slate-900 font-sans flex flex-col overflow-hidden">
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-6 flex flex-col lg:flex-row lg:items-center justify-between gap-4 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm font-semibold text-slate-600">
      ...
      <div className="max-w-[1400px] mx-auto px-6 mt-6 mb-6 flex-1 w-full flex flex-col overflow-hidden">
        <div className="flex flex-col xl:flex-row gap-8 flex-1 min-h-0">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {paginatedReports.map((report) => (
                      <tr
                        ...
                        className={`cursor-pointer transition-colors group ${selectedReportId === report.id ? 'bg-blue-50/50' : 'hover:bg-slate-50'}`}
                      >
              ...
              <div className="p-4 border-t border-slate-100 bg-slate-50 flex items-center justify-between text-xs text-slate-500 font-medium">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="px-3 py-1.5 bg-white border border-slate-200 rounded-md hover:bg-slate-100 transition-colors text-slate-700 font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                  >Previous</button>
                  <button 
          ...
          <div className="xl:w-[420px] shrink-0 flex flex-col min-h-0">
            ...
            <div className="flex-1 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden flex flex-col min-h-0">
              ...
              <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-3 shrink-0">
                ...
                <button 
                  ...
                  className="px-4 py-2.5 bg-white border border-slate-200 hover:bg-slate-100 text-slate-700 rounded-xl text-sm font-bold transition-colors flex items-center justify-center shadow-sm" title="Share Document"
                >
                  <Share2 size={16} />
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm" onClick={() => setIsGenerateModalOpen(false)}>
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50 flex justify-end gap-2">
              <button onClick={() => setIsGenerateModalOpen(false)} className="px-4 py-2 bg-white border border-slate-200 text-slate-700 font-medium rounded-lg hover:bg-slate-50 transition-colors text-sm">Cancel</button>
              <button onClick={() => {
        ...
        <div className="fixed inset-0 z-[60] bg-slate-900/20 backdrop-blur-sm flex justify-end" onClick={() => setIsShareSidepopOpen(false)}>
          ...
          >
            <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50">
              ...
              <button onClick={() => setIsShareSidepopOpen(false)} className="text-slate-400 hover:text-slate-600 bg-white p-1.5 rounded-md border border-slate-200 shadow-sm"><X size={16} className="lucide-x"/></button>
            </div>
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input type="text" readOnly value="https://app.sitesupervise.com/reports/s8d9fs" className="flex-1 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-500 font-mono" />
              ...
              <div>
                ...
                <div className="space-y-3">
                  <input type="email" placeholder="Email address..." className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  <textarea placeholder="Add a message (optional)..." className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 h-24"></textarea>
                  <button 
                    onClick={() => {
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-lg border border-transparent hover:border-slate-100 transition-colors cursor-pointer" onClick={() => toast.success(`Sent to ${user.name}`)}>
