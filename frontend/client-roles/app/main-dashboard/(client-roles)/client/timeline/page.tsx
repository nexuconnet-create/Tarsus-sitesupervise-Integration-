    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 pb-12 font-sans">
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-6">
          <div className="bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 flex flex-col">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-8 space-y-8">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 overflow-hidden relative">
          <h2 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-6 flex items-center gap-2">
            <Activity size={16} /> Phase Timeline
          </h2>
          ...
          <div className="relative overflow-x-auto pb-4 custom-scrollbar">
            <div className="min-w-[800px]">
              ...
              {/* Months Header row */}
              <div className="grid grid-cols-12 gap-0 border-b border-slate-200 pb-2 mb-4 text-[10px] font-bold text-slate-400">
              ...
              {/* The "Today" Marker */}
              <div className="absolute top-[3rem] bottom-0 left-[35%] w-px bg-red-400 border-l-2 border-dashed border-red-400 z-20 flex flex-col items-center shadow-[0_0_10px_rgba(248,113,113,0.5)]">
                <div className="bg-red-500 text-white text-[9px] font-bold px-2 py-0.5 rounded-full absolute -top-3">TODAY</div>
              </div>
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="h-10 relative flex items-center">
                  <div className="absolute left-0 w-[20%] h-8 bg-emerald-100 border border-emerald-300 rounded-lg flex items-center overflow-hidden">
                    {/* Inner Progress */}
                ...
                <div className="h-10 relative flex items-center">
                  <div className="absolute left-[18%] w-[40%] h-8 bg-blue-50 border border-blue-200 rounded-lg flex items-center overflow-hidden shadow-sm">
                ...
                {/* Track 3: Enclosure */}
                <div className="h-10 relative flex items-center">
                  <div className="absolute left-[40%] w-[30%] h-8 bg-indigo-50 border border-indigo-200 rounded-lg flex items-center overflow-hidden shadow-sm">
                ...
                <div className="h-10 relative flex items-center">
                  <div className="absolute left-[50%] w-[35%] h-8 bg-slate-50 border border-slate-200 border-dashed rounded-lg flex items-center overflow-hidden">
                ...
                {/* Track 5: Finishes */}
                <div className="h-10 relative flex items-center">
                  <div className="absolute left-[65%] w-[35%] h-8 bg-slate-50 border border-slate-200 border-dashed rounded-lg flex items-center overflow-hidden">
        ...
        <section>
          <h2 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-6 flex items-center gap-2">
            <Calendar size={16} /> Detailed Phase Breakdown
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 border-t-4 border-t-slate-300 shadow-sm p-5 hover:shadow-md transition-shadow opacity-75">
              <div className="flex justify-between items-start mb-4">
                <div>
            ...
            {/* Finishes (Pending) */}
            <div className="bg-white rounded-xl border border-slate-200 border-t-4 border-t-slate-300 shadow-sm p-5 hover:shadow-md transition-shadow opacity-60">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <span className="text-[10px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded uppercase">Pending</span>
