        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-slate-50 border border-slate-200 p-6 rounded-xl flex items-start gap-5">
                <div className="p-3 bg-white border border-slate-200 text-slate-600 rounded-xl shrink-0">
                  <Lock size={28} />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4 border-t border-slate-100 pt-6">
                <div className="p-3 bg-slate-50 text-slate-600 border border-slate-200 rounded-xl shrink-0">
                  <RotateCcw size={24} />
                </div>
                <div>
                  ...
                  <select defaultValue="30 minutes" className="bg-slate-50 border border-slate-200 rounded-lg px-3 py-1.5 text-sm font-medium text-slate-700 outline-none">
